...
class CreateVestidosProducts extends Migration
{
    ...
    public function up()
    {
        Schema::create('vestidos_products', function (Blueprint $table) {
            ...
            $table->foreign("category_id")->references("id")->on("vestidos_categories");
            ...
            $table->foreign("product_fit_id")->references("id")->on("vestidos_fit_types");
            ...
            $table->foreign("product_waistline_id")->references("id")->on("vestidos_waistline_types");
