    ...
    <div class="row">
        <div class="col-lg-9 container-in-center">
            <div>
                ...
                <h2>{{$page_title}}</h2>
                <br/>
                <p>Términos y Condiciones Generales A continuación, nuestros Términos y condiciones generales, los cuales se aplican a la prestación de todos los servicios en <b>www.vestidosboutique.com</b> le ofrecemos una experiencia de compras personalizada y servicios a la medida de sus intereses y necesidades. En <b>www.vestidosboutique.com</b> vendemos vestidos de fiestas, quinceañeras y artículos en STOCK y por pedido especiales de nuestro selecto proveedores.
                </p>
                <ol>
                    <li><b>Para pedido</b>
                        <ol>
                    ...
                    <li><b>Forma de Pago</b>
                        <ol>
                            <li>Aceptamos las siguientes formas de pago para su pedido en línea en <b>vestidosboutique.com</b>:
                                <ul>
                                    <li>ACH Transferencia Bancaria o depósito bancario
                                        <ul>
                                            ...
                                            <li>Una vez realizado el pago debe enviar el comprobante a nuestro correo <b>pedidos@vestidosboutique.com</b> para agilizar el proceso.</li>
                                        </ul>
                    ...
                    <li><b>Plazo de Entrega</b>
                        <ol>
                            <li>Los artículos categorizado como &#42;EN STOCK&#42; está disponible para entrega inmediata y los artículos categorizado como &#42;PEDIDO ESPECIAL&#42; tiene una fecha estimada de entrega entre 4 a 14 semanas dependiendo de nuestros proveedores.</li>
                        </ol>
                    </li>
                    ...
                    <li><b>Cancelación</b>
                        <ol>
                            <li>Si no se ha efectuado un pago a su pedido, puede cancelarla fácilmente enviando los datos a nuestro email <b>pedidos@vestidosboutique.com</b> </li>
                            <li>Si su pedido ha sido pagado y aún está en status &#34;en proceso&#34;, puede solicitar la cancelación a través de nuestro email <b>pedidos@vestidosboutique.com</b>. Por favor contáctenos si desea cancelar algunos artículos en el pedido. Si se comunica con nosotros para cancelar dentro de las 24 horas posteriores al pago, le daremos un reembolso completo. Si han transcurrido más de 24 horas, le cobraremos un cargo por cancelación de 25&#37; del valor pagado.</li>
