    ...
    <div class="row">
        <div class="col-lg-9 container-in-center">
            <div>
                ...
                <h2>{{$page_title}}</h2>
                <br/>
                <p>Términos y Condiciones Generales A continuación, nuestros Términos y condiciones generales, los cuales se aplican a la prestación de todos los servicios en <b>www.vestidosboutique.com</b> le ofrecemos una experiencia de compras personalizada y servicios a la medida de sus intereses y necesidades. En <b>www.vestidosboutique.com</b> vendemos vestidos de fiestas, quinceañeras y artículos en STOCK y por pedido especiales de nuestro selecto proveedores.</p>
                <ol>
                    <li><b>Para pedido</b>
                        <ol>
                    ...
                    <li><b>Forma de Pago</b>
                        <ol>
                            <li>Aceptamos las siguientes formas de pago para su pedido en línea en <b>www.vestidosboutique.com</b>:
                                <ul>
                                    <li>ACH Transferencia Bancaria o depósito bancario
                                        <ul>
                                            ...
                                            <li>Para ampliar y extender el plazo solicitar a través del <b>info@vestidosboutique.com</b></li>
                                            <li>Una vez realizado el pago debe enviar el comprobante a nuestro correo <b>info@vestidosboutique.com</b> para agilizar el proceso.</li>
                                        </ul>
