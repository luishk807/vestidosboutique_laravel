    ...
    <div class="row admin_orders_row">
        ...
        <div class="col-md-11">
            <div class="row py-3 order_admin_header">
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">${{ (($order->order_total + $order->order_tax + $order->order_shipping) - $order->order_discount) + $order->delivery_speed_cost }}</div>
            ...
            <div class="row order_admin_grid">
                <div class="col">
                    <!--amount paid-->
                    @php($amount_due = ((($order->order_total + $order->order_tax) - $order->order_discount) + $order->delivery_speed_cost) - $order->paymentHistories->sum('total'))
