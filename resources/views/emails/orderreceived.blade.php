    ...
    <tr>
        <td colspan='2' width="100%">
            <table width="100%">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_received.line_14') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_received.line_15') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_received.line_18') }}</strong>
                    </td>
                    <td align="right">
