<table>
    ...
    <tr>
        <td colspan='2'>
            ...
            This email is to confirm your order has been successfully cancelled. The amount of {{ $order_detail["order"]["order_grand_total"]}}.<br/><br/>
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
            ...
            <table width="100%">
                <tr>
                    <td width="50%" align="left" valign="top">
                        ...
                        {{ $order_detail["order"]["shipping_city"] }} {{ $order_detail["order"]["shipping_state"] }} {{ $order_detail["order"]["shipping_province"] }} {{ $order_detail["order"]["shipping_zip_code"] }}<br/>
                    ...
                    <td width="50%" align="left" valign="top">
                        ...
                        {{ $order_detail["order"]["billing_city"] }} {{ $order_detail["order"]["billing_state"] }} {{ $order_detail["order"]["billing_province"] }} {{ $order_detail["order"]["billing_zip_code"] }}<br/>
