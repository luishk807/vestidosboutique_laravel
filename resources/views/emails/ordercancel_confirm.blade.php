<table>
    ...
    <tr>
        <td colspan='2'>
            {{ __('emails.order_user_cancel.line_hello',['name'=>$order_detail["user"]["first_name"]]) }},<br/><br/>
            {{ __('emails.order_user_cancel.line_1',['total'=>$order_detail["order"]["order_grand_total"]]) }}<br/><br/>
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
            ...
            <table width="100%">
                <tr>
                    <td width="30%" align="left" valign="top">
                        <strong>{{ __('emails.order_user_cancel.line_2') }}</strong>
                    </td>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="50%" align="left" valign="top">
                        <strong>{{ __('emails.order_user_cancel.line_3') }}</strong>
                    </td>
                    @endif
                    <td width="{{ $order_detail['order']['allow_shipping']=='true'? '50%' : '100%'}}" align="left" valign="top">
                        <strong>{{ __('emails.order_user_cancel.line_4') }}</strong>
                    </td>
    ...
    <tr>
        <td colspan='2'><strong>{{ __('emails.order_user_cancel.line_5') }}</strong></td>
    </tr>
        ...
        <td colspan='2' width="100%">
            <table width="100%">
                <tr>
                    ...
                    {{ __('emails.order_user_cancel.line_6') }}
                    </th>
                    <th width="10%" align="center">
                    {{ __('emails.order_user_cancel.line_7') }}
                    </th>
                    <th width="20%" align="right">
                    {{ __('emails.order_user_cancel.line_8') }}
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top" align="center">
                        {{ $product["name"] }}<br/>
                        {{ __('emails.order_user_cancel.line_9') }}: {{ $product["size"] }}<br/>
                        {{ __('emails.order_user_cancel.line_10') }}: {{ $product["color"] }}
                    </td>
                    <td valign="top" align="center">
                        {{ $product["quantity"] }}
                    </td>
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_cancel.line_11') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_cancel.line_12') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_cancel.line_13') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_user_cancel.line_16') }}</strong>
                    </td>
                    <td align="right">
                        @if($order_detail['order']['allow_shipping']=="true")
