    ...
    <tr>
        <td colspan='2' width="100%">
            <table width="100%">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_cancel_request.line_15') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_cancel_request.line_16') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_cancel_request.line_19') }}</strong>
                    </td>
                    <td align="right">
