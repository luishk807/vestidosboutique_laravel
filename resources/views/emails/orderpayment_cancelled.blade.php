<table>
    ...
    <tr>
        <td colspan='2'>
            {{ __('emails.order_payment_removed.line_hello',['name'=>$order_detail["user"]["first_name"]]) }},<br/><br/>
            {{ __('emails.order_payment_removed.line_1') }}<br/><br/>
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
            ...
            <table width="100%">
                <tr>
                    <td width="30%" align="left" valign="top">
                        <strong>{{ __('emails.order_payment_removed.line_2') }}</strong>
                    </td>
        ...
        <td colspan="2">
            <table width="100%">
                <tr>
                    ...
                    {{ __('emails.order_payment_removed.line_3') }}
                    </td>
                    <td width="35%" align="center" valign="top">
                    {{ __('emails.order_payment_removed.line_4') }}
                    </td>
                    <td width="25%" align="center" valign="top">
                    {{ __('emails.order_payment_removed.line_6') }}
                    </td>
                </tr>
                @php($counter=0)
                @if(array_key_exists("payments",$order_detail))
                @foreach($order_detail["payments"] as $payment)
                @php($counter++)
                <tr>
                    <td colspan="4"><hr/></td>
                </tr>
                <tr>
                    ...
                    <td width="35%" align="center" valign="top">
                        ${{ number_format($payment->col_2,'2','.',',') }}
                    </td>
                    <td width="25%" align="center" valign="top">
                        {{ date('m-d-Y', strtotime($payment->col_4)) }}
                    </td>
                </tr>
                @endforeach
                @else
    ...
    <tr>
        <td colspan='2'><strong>{{ __('emails.order_payment_removed.line_7') }}</strong></td>
    </tr>
        ...
        <td colspan='2' width="100%">
            <table width="100%">
                <tr>
                    ...
                    {{ __('emails.order_payment_removed.line_8') }}
                    </th>
                    <th width="10%" align="center">
                    {{ __('emails.order_payment_removed.line_9') }}
                    </th>
                    <th width="20%" align="right">
                    {{ __('emails.order_payment_removed.line_10') }}
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top" align="center">
                        {{ $product["name"] }}<br/>
                        {{ __('emails.order_payment_removed.line_11') }}: {{ $product["size"] }}<br/>
                        {{ __('emails.order_payment_removed.line_12') }}: {{ $product["color"] }}
                    </td>
                    <td valign="top" align="center">
                        {{ $product["quantity"] }}
                    </td>
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_payment_removed.line_13') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_payment_removed.line_16') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_payment_removed.line_17') }}</strong>
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="3" align="right">
                        <strong>{{ __('emails.order_payment_removed.line_18') }}</strong>
                    </td>
                    <td align="right">
