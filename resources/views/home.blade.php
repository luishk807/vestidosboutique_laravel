        ...
        <div class="intro">
                <div class="container">
                    ...
                    <div id="top_middle_sec_row" class="row">
                        ...
                        <div id="top_middle_img{{ $keyIndex+1 }}" class="col-12 col-sm-4 col-md-4 col-xl-4">
                            @if($top_dress->is_new)
