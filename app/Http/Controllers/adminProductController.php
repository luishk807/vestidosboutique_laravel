...
{
    //
    public function __construct(Images $images, vestidosStatus $vestidosStatus, Products $products,Categories $categories, Closures $closures,Colors $colors, Brands $brands, Fits $fits, Fabrics $fabrics, Sizes $sizes,  Vendors $vendors, Necklines $necklines, Waistlines $waistlines, ProductCategories $product_categories,ProductsRestocks $products_restocks){
        ...
        $this->images = $images;
        $this->products_restocks = $products_restocks;
